...
public class InformationFrame extends JFrame{
	...
	public InformationFrame() {
		...
		menu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				InformationFrame.this.dispatchEvent(new WindowEvent(InformationFrame.this, WindowEvent.WINDOW_CLOSING));
			}
		});
	...
	private void displayInfo() {
		...
		sb.append("Eliminated pieces are removed from the board, can not be created again and are placed in\n" + 
				"the cemetery.");
		sb.append("• At the start of your turn you may create a piece if your creation grid is empty. Your creation\n" + 
